    ...
    return (
      <View style={styles.outro}>
        ...
        <View style={styles.overlay}>
          <Image
            source={require("../../assets/images/melancia.gif")}
      ...
      <ScrollView style={[styles.comprasAntigas]}>
              ...
              >
                <Text
                  style={[
                    styles.nomeB,
                    styles.button,
                    { color: isDarkMode ? "rgba(0, 0, 0, 0.91)" : "#ffffff" },
                  ]}
                >
                  Pagar
                </Text>
              ...
              >
                <Text
                  style={[
                    styles.nomeB,
                    styles.button,
                    { color: isDarkMode ? "rgba(0, 0, 0, 0.74)" : "#ffffff" },
                  ]}
                >
                  Comprar
                </Text>
        ...
        {dadosComprasPuro.length == 0 ? (
          <View style={[styles.nadaAinda]}>
            <Text style={{ color: "#fff" }}>Nada ainda</Text>
            <Image
              source={require("../../assets/images/melancia.gif")}
              style={{ width: 150, height: 150 }}
            />
                ...
                style={[
                  styles.infor,
                  {
                    backgroundColor: isDarkMode
                      ? "rgba(0, 0, 0, 1)"
                      : "rgba(255, 255, 255, 1)",
                    borderColor: isDarkMode ? branco : "rgba(0, 0, 0, 0.47)",
                  },
                ]}
              >
